          ...
          {!isOnAdmin && (
            <>
              ...
              >
                ...
                <span className="text-[10px] bg-gradient-to-r from-amber-400 to-orange-400 text-white px-2 py-0.5 rounded-full font-bold uppercase tracking-wider shadow-sm">
                  Beta
                </span>
